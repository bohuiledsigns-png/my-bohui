...
_JIMENG_AK = os.environ.get("JIMENG_AK", "AKLTNGYxMzczZmVmNDlmNDM5NDgyNzBkNTgwYWU5ODA4NDQ")
_JIMENG_SK = os.environ.get("JIMENG_SK", "T0dSaE1XSmtPVFZrTWpjd05EWXdNR0V4WlRNd05XSmlNbVE0WlRnMlltRQ==")
_JIMENG_SERVICE = "cv"
